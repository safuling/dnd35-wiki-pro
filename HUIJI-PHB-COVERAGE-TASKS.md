...
## 2026-06-23 PHB 专长页面模板统一

- [x] 已给 29 个旧 PHB 专长详情页补充统一标准摘要区块：`专长概要`、`效果`、`覆盖说明`。
- [x] 已保留旧页原有机制详解、战术说明和规则冲突记录，不做内容删减。
- [x] 已更新 `data/phb-feat-page-audit.json`：109 / 109 页面通过模板结构审计。
